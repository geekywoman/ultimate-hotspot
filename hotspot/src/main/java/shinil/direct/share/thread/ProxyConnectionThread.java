...
public final class ProxyConnectionThread extends Thread {
    ...
    ProxyConnectionThread(Socket socket) {
        this.socket = socket;
        start();
    }
    ...
    public void run() {
        ...
        try {
            ...
            do {
                ...
                stringBuilder.append(new String(value, 0, read));
            } while (inputStream.available() > 0);
            ParseRequest ParseRequest = new ParseRequest(stringBuilder.toString());
            if (ParseRequest.flag) {
                ...
                if (ParseRequest.requestType.equals("CONNECT")) {
                    try {
                        ...
                        try {
                            outputStream.write((ParseRequest.protocol
                ...
                try {
                    ...
                    try {
                        ...
                        outputStream2.write(stringBuilder.toString().getBytes());
                        outputStream2.flush();
                        try {
